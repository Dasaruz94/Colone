                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-2x flaticon-pointing"></i>     Registro de Espacio
                            ...
                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Registra un espacio compartido, y se mostrará disponible para reservación  </p>

                            <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/createController.php?a=createSpace">

                            <div style="width: 100%;">
                                <input type="file" name="image" id="file-7" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple />
                                <label for="file-7"><span></span> <strong><i class="flaticon-photo-camera-1"></i> Imagen del lugar&hellip;</strong></label>
                            </div>
                            ...
                            <div class="form">
                                    ...
                                    <div class="col-lg-3">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="name_place" name="name_space"  type="text" />
                                    ...
                                    <div class="col-lg-9" >
                                             ...
                                             <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="description_place"  name="description"  type="text" />
                                                    <label for="name" class="input__label input__label--fumi ">
                                    ...
                                    <div class="col-lg-12" style="padding-left: 0px; padding-right: 0px;">
                                        ...
                                        <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input  id="time-start" class=" input__field input__field--fumi" id="start_hour" name="start_hour"  type="time" />
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <span class="input input--fumi ">
                                                    <input id="time-end" class=" input__field input__field--fumi" id="end_hour" name="end_hour"  type="time" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x flaticon-clock icon icon--fumi"></i>
                                    ...
                                    <div class="col-lg-offset-4 col-lg-6">
                                        ...
                                        <div class="form-group" style="margin-top: 35px; margin-bottom: 35px; margin-left: 33px;">
                                            <button class="btn hvr-bounce-to-right" type="submit">Registrar   <i class="fa fa-check"></i></button>
