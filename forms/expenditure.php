                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                             <i class="fa fa-2x flaticon-bars-1"></i>  Egresos
                            ...
                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Da de alta un egreso</p>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="expenditureForm" method="post" action="../controllers/createController.php?a=createExpenditure&id=<?php echo $_GET['id']?>">
                                        ...
                                        <div class="col-lg-4">
                                                ...
                                                <span class="input input--fumi ">
                                                    ...
                                                    <input class=" input__field input__field--fumi only-numbers only-decimal-numbers"  id="number"  name="total_expenditure" type="double"  />
