                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                               <i class="fa fa-2x flaticon-megaphone"></i>  Registro de anuncios
                            ...
                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Registra un anuncio para tu zona, todos podrán verlos y ser notificados de lo que quieres decir.</p>


                              <div style="width: 100%;">

                            <form  enctype="multipart/form-data" id="upload" method="post" action="../controllers/createController.php?a=createNotice" style="padding: 0px;">

                                <input type="file" name="document" id="file-7" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple />
                                <label for="file-7"><span></span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> Documento&hellip;</strong></label>
                            </div>
                                            ...
                                            <div class="col-lg-9">
                                                        <span class="input input--fumi ">
                                                            ...
                                                            <label for="name" class="input__label input__label--fumi ">
                                                                <i class="fa fa-fw fa-3x flaticon-chat-1 icon icon--fumi"></i>
                                                ...
                                                <span class="input " >
                                                   ...
                                                   <textarea class="input__field_textarea input__field--fumi_textarea" id="notice"  name="notice"></textarea>
                                                    <label for="name" class="input__label_textarea input__label--fumi_textarea ">
                                                        ...
                                                        <span class="input__label-content_textarea input__label-content--fumi_textarea">Anuncio / Aviso*</span>
                                                    </label>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-offset-4 col-lg-6">
                                                    ...
                                                    <div class="form-group" style="margin-top: 140px; margin-bottom: 35px; margin-left: 33px;">
                                                        <button class="btn hvr-bounce-to-right" type="submit">Subir   <i class="fa ion-upload"></i></button>
