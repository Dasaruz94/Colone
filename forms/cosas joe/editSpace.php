                                ...
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/updateController.php?a=updateSpace&id=<?php echo $_GET['id']; ?>">
                                        ...
                                        <div class="form-group" style="margin-top: 35px; margin-bottom: 35px; margin-left: 1px;" >
                                            ...
                                            <div class="controls col-md-9">
                                                ...
                                                <span class="btn btn-white btn-file hvr-bounce-to-right">
                                                 <span class="fileupload-new"><i class="fa fa-picture-o"></i>   Actualizar imagen del lugar</span>
                                    ...
                                    <div class="col-lg-9">
                                          ...
                                          <span class="input_textarea " >
                                              ...
                                              <textarea class="input__field_textarea input__field--fumi_textarea" id="description_place"  name="description"><?php echo $description; ?></textarea>
                                                    <label for="name" class="input__label_textarea input__label--fumi_textarea ">
                                                        ...
                                                        <span class="input__label-content_textarea input__label-content--fumi_textarea">Descripción*</span>
                                                    </label>
