                                ...
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/createController.php?a=createSpace">
                                        ...
                                        <div class="form-group" style="margin-top: 35px; margin-bottom: 35px; margin-left: 1px;" >
                                            ...
                                            <div class="controls col-md-9">
                                                ...
                                                <span class="btn btn-white btn-file hvr-bounce-to-right">
                                                 <span class="fileupload-new"><i class="fa fa-picture-o"></i>   Imagen del lugar</span>
                                    ...
                                    <div class="col-lg-9" >
                                          ...
                                          <span class="input_textarea " >
                                              ...
                                              <textarea class="input__field_textarea input__field--fumi_textarea" id="description_place"  name="description"></textarea>
