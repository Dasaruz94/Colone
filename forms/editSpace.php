                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                               <i class="fa fa-2x flaticon-pointing"></i>  Editar Espacio
                            ...
                            $consulta = "SELECT * FROM space WHERE id_space LIKE '".$_GET['id']."'";
                            ...
                            ?>
                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;"> Edita los datos del espacio   </p>
                            <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/updateController.php?a=updateSpace&id=<?php echo $_GET['id']; ?>">
                            <div style="width: 100%;">
                                <input type="file" name="image" id="file-7" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple />
                                <label for="file-7"><span></span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> Nueva imagen del lugar&hellip;</strong></label>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/updateController.php?a=updateSpace&id=<?php echo $_GET['id']; ?>">
                                    ...
                                    <div class="col-lg-3">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="name" value="<?php echo $name; ?>" name="name_space"  type="text" />
                                ...
                                <div class="col-lg-9" >
                                             ...
                                             <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="description_place" value="<?php echo $description; ?>"  name="description" type="text" />
                                                    <label for="description" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x ion-information icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">Descripción Breve*</span>
                                                    </label>
                                                </span>
                                    ...
                                    <div class="col-lg-12" style="padding-left: 0px; padding-right: 0px;">
                                        ...
                                        <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input  id="time-start" class=" input__field input__field--fumi" id="start_hour" value="<?php echo $startHour; ?>" name="start_hour"  type="time" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x ion-clock icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">Horario disponible de:</span>
                                                    </label>
                                                </span>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input id="time-end" class=" input__field input__field--fumi" id="end_hour" value="<?php echo $endHour; ?>" name="end_hour"  type="time" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x ion-clock icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">a:</span>
                                                    </label>
                                                </span>
                                        </div>
                                    ...
                                    <div class="col-lg-offset-4 col-lg-4">
                                        ...
                                        <div class="form-group" style="margin-top: 10px; margin-bottom: 35px; margin-left: 33px;">
