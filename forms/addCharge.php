...
if(isset($_SESSION['email'])) {
    ...
    if($_SESSION['tipo_usuario']== 1){
        ...
        <head>
            ...
            <meta name="descriptyrcf5ion" content="">
                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                          <i class="fa fa-2x flaticon-money"></i>   Cargo a un usuario
                            <span class="tools pull-right">
                                <a class="fa fa-chevron-down" href="javascript:;"></a>
                                <a class="fa fa-times" href="javascript:;"></a>
                             </span>

                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Da de alta un cargo a un solo usuario</p>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="charge" method="post" action="../controllers/createController.php?a=createChargeOne">
                                    ...
                                    <div class="col-lg-4">
                                        <section>
                                            ...
                                            <select name="id_user" style="padding: 26px; border:none; border-bottom: 5px solid #e8e8e8; margin-top: 17px; width: 94%;
                                                ...
                                                while ($row=mysqli_fetch_row($resultado)) {
                                                    ...
                                                    $consulta2 = "SELECT * FROM user_data WHERE id_user LIKE '".$row[0]."' AND active LIKE 1";
                                                    ...
                                                    <option value="<?php echo $row[0]; ?>"><?php echo $name.' ('.$num_place.')' ?></option>
                                    ...
                                    <div class="col-lg-4">
                                     <span class="input input--fumi ">
                                                    ...
                                                    <input class=" input__field input__field--fumi only-numbers only-decimal-numbers"  id="number"  name="total" type="double"  />
                                                    <label for="" class="input__label input__label--fumi ">
                                                        ...
                                                        <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="concept" name="subject"  type="text" />
                                    ...
                                    <?php ?>
                                                 <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input  id="date" class=" input__field input__field--fumi" id="date" name="limit_date" type="text" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
