...
<head>
 ...
 <meta name="description" content="">
    ...
    <title>Notificación individual</title>
        ...
        <section class="wrapper">
            ...
            <section class="panel">
                <header class="panel-heading">
                   <i class="fa fa-2x flaticon-technology"></i>   Notificación
                    ...
                    <p style="font-weight: 200; text-transform: none; margin-top: 20px;">  Mantén informados a  los usuarios, crea notificaciones a tus usuarios, solo <span style='font-weight: 900; color: #008bff;'> ingresa </span> título y el cuerpo del aviso, <span style='font-weight: 900; color: #008bff;'>  envía y listo </span></p>
                    <span  style="font-weight: 700; text-transform: none; margin-top: 20px;"> <span class="label label-warning pull-left" style="margin-right: 20px; font-size:13px;">¡Nota!</span>    Estos avisos serán vistos como notificaciones en la app del usuario seleccionado</span></p>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                               ...
                               <div class="form">
                                        <form class="cmxform form-horizontal" id="adviceForm" method="post" action="../controllers/updateNotificacion.php?a=mensaje&id=<?php echo $_GET['id']; ?>">
                                            <div class="col-lg-12">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="name_place" name="title"  type="text" />
                                                    <label for="name" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x flaticon-chat icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">Asunto*</span>
                                                    </label>
                                                </span>
                                            ...
                                            <span class="input " >
                                              ...
                                              <textarea class="input__field_textarea input__field--fumi_textarea" id="description_place"  name="body"></textarea>
                                                    <label for="name" class="input__label_textarea input__label--fumi_textarea ">
                                                        <i class="fa fa-fw fa-3x flaticon-technology icon icon--fumi"></i>
                                                        <span class="input__label-content_textarea input__label-content--fumi_textarea">Notificación*</span>
                                                    </label>
                                            ...
                                            <div class="col-lg-offset-4 col-lg-6">
                                                ...
                                                <div class="form-group" style="margin-top: 140px; margin-bottom: 35px; margin-left: 33px;">
                                                    <button class="btn hvr-bounce-to-right" type="submit">Enviar   <i class="fa ion-android-send"></i></button>
