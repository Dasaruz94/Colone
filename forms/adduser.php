        ...
        <section class="wrapper">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <a href='../../sign-up-user.php' style="color: #008bff; font-weight: 800;">www.colone.com/sign-up-user.php</a>  </p>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                               ...
                               <div class="form">
                                        <form class="cmxform form-horizontal" id="signupForm" method="post" action="../controllers/createController.php?a=createColonoAdm">

                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="name" name="name"  type="text" />
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="ap" name="ap"  type="text" />
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="am" name="am"  type="text" />
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" type="text" data-mask="(999) 999-9999" id="tel" name="tel"  />
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="password" name="password" type="password" />
                                                    <label for="password" class="input__label input__label--fumi input__label--fumi-color-1">
                                                        <i class="fa fa-fw fa-3x flaticon-locked icon icon--fumi"></i>
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi"  id="confirm_password" name="confirm_password" type="password" />
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="num_place" name="num_place" type="text" />
                                                    <label for="int" class="input__label input__label--fumi input__label--fumi-color-1">
                                                        <i class="fa fa-fw fa-3x flaticon-home icon icon--fumi"></i>
