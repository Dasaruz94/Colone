        ...
        <section class="wrapper">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <span  style="font-weight: 700; text-transform: none; margin-top: 20px;"> <span class="label label-warning pull-left" style="margin-right: 20px; font-size:13px;">¡Nota!</span>    Estos avisos serán vistos como notificaciones en la app de cada usuario </span></p>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                               ...
                               <div class="form">
                                        <form class="cmxform form-horizontal" id="adviceForm" method="get" action="">
                                            <div class="col-lg-12">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="name_place" name="name_place"  type="text" />
                                            ...
                                            <span class="input " >
                                              ...
                                              <textarea class="input__field_textarea input__field--fumi_textarea" id="description_place"  name="description_place"></textarea>
                                            ...
                                            <div class="col-lg-offset-4 col-lg-6">
                                                ...
                                                <div class="form-group" style="margin-top: 140px; margin-bottom: 35px; margin-left: 33px;">
                                                    <button class="btn hvr-bounce-to-right" type="submit">Emviar   <i class="fa ion-android-send"></i></button>
