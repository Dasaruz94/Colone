                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa fa-2x flaticon-money"></i>  Cargo a todos los usuarios
                            <span class="tools pull-right">
                                <a class="fa fa-chevron-down" href="javascript:;"></a>
                                <a class="fa fa-times" href="javascript:;"></a>
                             </span>

                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Da de alta un cargo a todos los usarios de la zona </p>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="charge" method="post" action="../controllers/createController.php?a=createChargeAll">
