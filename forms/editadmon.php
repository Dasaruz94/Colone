        ...
        <section class="wrapper">
            ...
            <section class="panel">
                <header class="panel-heading">
                      <i class="fa fa-2x flaticon-social"></i>   Editar Administrador


                    <p style="font-weight: 200; text-transform: none; margin-top: 20px;"> Edita los datos del administrador   </p>
                ...
                <div class="panel-body">
                    ...
                    $consulta = "SELECT * FROM user_data WHERE id_user LIKE '".$_SESSION['id']."'";
                    ...
                    <div class="form">
                        <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/updateController.php?a=updateAdmin">
                            ...
                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="ap" value="<?php echo $ap; ?>" name="ap"  type="text" />
                            ...
                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="am" value="<?php echo $am; ?>" name="am"  type="text" />
                            ...
                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" type="text" placeholder="" value="<?php echo $tel; ?>" data-mask="(999) 999-9999" id="tel" name="tel"  />
                                                    <label for="tel" class="input__label input__label--fumi input__label--fumi-color-1">
                            ...
                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="password" value="<?php echo $_SESSION['password']; ?>" name="password" type="password" />
                                                    <label for="password" class="input__label input__label--fumi input__label--fumi-color-1">
                            ...
                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" value="<?php echo $_SESSION['password']; ?>" id="confirm_password" name="confirm_password" type="password" />
                                                    <label for="confirm_password" class="input__label input__label--fumi input__label--fumi-color-1">
                                                        <i class="fa fa-fw fa-3x ion-ios-locked icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">Confirma la contraseña</span>
                                                    </label>
                                                </span>
                            </div>
                    ...
                    <header class="panel-heading">
                        ...
                        <p style="font-weight: 200; text-transform: none; margin-top: 20px;"> En esta sección podrás modificar
                        el logotipo de tu zona</p>
                                ...
                                <div class="controls col-md-9">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <span class="btn btn-white btn-file hvr-bounce-to-right">
                                                 <span class="fileupload-new"><i class="fa fa-paper-clip"></i>Cambiar Logotipo Actual</span>
                                                 <span class="fileupload-exists"><i class="fa fa-undo"></i> Cambiar</span>
                                                <input type="file" name="logotype" class="default" />
                                                </span>
