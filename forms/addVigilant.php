...
if(isset($_SESSION['email'])) {
    ...
    if($_SESSION['tipo_usuario']== 1){
        ...
        <head>
            ...
            <title>Registro de vigilantes</title>
                ...
                <section class="wrapper">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                                <i class="fa fa-2x flaticon-shield-1"></i> Registro de Vigilante
                            <span class="tools pull-right">
                                <a class="fa fa-chevron-down" href="javascript:;"></a>
                                <a class="fa fa-times" href="javascript:;"></a>
                             </span>

                            <p style="font-weight: 200; text-transform: none; margin-top: 20px;">Es sencillo, solo asigna nombre y foto.  </p>

                            <form class="cmxform form-horizontal" id="signupForm" method="post" enctype="multipart/form-data" action="../controllers/createController.php?a=createVigilant">
                             
                              <div style="width: 100%;">

                                <input type="file" name="image" id="file-7" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple />
                                <label for="file-7"><span></span> <strong><i class="flaticon-photo-camera-1"></i> Foto del vigilante&hellip;</strong></label>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                    ...
                                    <div class="col-lg-6">
                                               <span class="input input--fumi ">
                                                    ...
                                                    <label for="name" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x flaticon-shield-1 icon icon--fumi"></i>
                                    ...
                                    <div class="col-lg-6">
                                               <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="uservigilant" name="uservigilant"  type="text" />
                                                    <label for="uservigilant" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x flaticon-eye icon icon--fumi"></i>
                                    ...
                                    <div class="col-lg-4">
                                               <span class="input input--fumi ">
                                                    <input class=" input__field input__field--fumi" id="passwordv" name="passwordv"  type="password" />
                                                    <label for="password" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x flaticon-locked icon icon--fumi"></i>
                                                        <span class="input__label-content input__label-content--fumi">Repetir Contraseña*</span>
                                                    </label>
                                                </span>
                                    </div>
