        ...
        <ul class="nav top-menu">
            ...
            <li id="header_notification_bar" class="dropdown">
                ...
                <ul class="dropdown-menu extended inbox">
                    <li>
                        <p class="red">3 Notificaciones</p>
                    </li>
                    <li>
                        <a href="#">

                                <span class="subject">
                                <span class="from">Carlos González</span>
                                <span class="time">21 Mayo</span>
                                </span>
                            <span class="message">
                                   jeje...
                                </span>
                    ...
                    <li>
                        <a href="suggestion.php">Ver todos</a>
                    </li>
                </ul>
            </li>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a href="../views/suggestion.php">
                        <span style="margin-right: 5px; ; font-size: 15px;" class="badge bg-success">3</span>
