                        ...
                        <div class="col-sm-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <i class="fa fa-2x fa-users"></i>  Cargos
                            ...
                            <a href="javascript:;" class="fa fa-times"></a>
                                    ...
                                    <p style="font-weight: 200; text-transform: none; margin-top: 20px;">  Lista de tus cargos </p>
                                    ...
                                    <section id="no-more-tables">
                                        <div class="adv-table editable-table ">
                                            ...
                                            <table class="table table-bordered table-striped table-condensed cf" id="editable-sample">
                                                ...
                                                $consulta = "SELECT * FROM charge WHERE id_user LIKE '".$_SESSION['id']."' AND active LIKE 1";
