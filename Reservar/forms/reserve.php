                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="signupForm" method="post" action="../controllers/createController.php?a=createSpace">
                                        ...
                                        <form id="date-form" action="#" class="form-horizontal ">
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input  id="date" class=" input__field input__field--fumi" id="subject_reserve" name="subject_reserve"  type="text" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input  id="time-start" class=" input__field input__field--fumi" id="subject_reserve" name="subject_reserve"  type="text" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                            ...
                                            <div class="col-lg-4">
                                                <span class="input input--fumi ">
                                                    <input id="time-end" class=" input__field input__field--fumi" id="subject_reserve" name="subject_reserve"  type="text" />
                                                    <label for="subject_reserve" class="input__label input__label--fumi ">
                                                        <i class="fa fa-fw fa-3x ion-clock icon icon--fumi"></i>
                                            ...
                                            <div class="col-lg-4">
                                                <section>
                                                    ...
                                                    <select class="cs-select cs-skin-rotate input__field ">

                                                        <option value="1">Sala de Juntas</option>
                                                        <option value="2">Salón de conferencias</option>
                ...
                bttn.addEventListener( 'click', function() {
                    ...
                    var notification = new NotificationFx({
                        message : '<span style="position: relative; top: 30px;" class="icon icon-clock"></span>' +
                            ...
                            '<li>Daniel Sanchez Ruiz: 11:00 - 13:00</li><li>Carlos González: 14:00 - 15:15</li></p>',
                        layout : 'bar',
                        effect : 'exploader',
                        ttl : 9000000,
