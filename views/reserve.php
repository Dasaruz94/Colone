            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-2x flaticon-calendar"></i>Historial de reservaciones de areas compartidas
                    ...
                    <div class="panel-body">
                        ...
                        <div class="btn-group">
                            <a href="../forms/reserve.php"><button class="btn btn-primary">
                                    Reservar <i class="fa fa-calendar-o"></i>
                                </button></a>
                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <div class="space15"></div>
                                ...
                                $consulta = "SELECT * FROM reserve WHERE id_place LIKE '".$_SESSION['id_place']."'AND active LIKE 1";
                                ...
                                while ($row=mysqli_fetch_row($resultado))
                                {
                                    ...
                                    <tr class="">
                                        <td class="center">
                                            <?php  $consulta1 = "SELECT * FROM user_data WHERE id_user LIKE '".$row[3]."'";
                                        ...
                                        <td class="center">
                                            <?php  $consulta2 = "SELECT * FROM space WHERE id_space LIKE '".$row[2]."'";
