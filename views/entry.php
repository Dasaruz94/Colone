            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <p style="font-weight: 200; text-transform: none; margin-top: 20px;"> Historial de ingresos </p>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        <a href="../forms/entry.php?id=<?php echo $_GET['id']?>" class="tooltipcolone"><button  id="editable-sample_new" class="btn btn-primary tooltipcolone">
                                                <span class="tooltipcolone-content">Nuevo ingreso </span>

                                                Ingreso <i class="fa fa-plus"></i>
                                            </button></a>
                            ...
                            <table class="table table-bordered table-striped table-condensed cf" id="editable-sample">
                                ...
                                <?php
                                    $consulta = "SELECT * FROM entry WHERE id_finance LIKE '".$_GET['id']."' AND active LIKE 1";
                                    ...
                                    <td class="center" style="color: blue;"><?php echo '$'.number_format($total_entry,2);?></td>
                                    <td class="center"><?php echo $concept; ?></td>
                                    <td class="center"><?php echo $created_at; ?></td>
                                    <td><a class="delete""><button onclick="validateRemoveEntry(<?php echo $row1[0]; ?>)"   type="button" class="btn btn-danger"><i class="fa fa-ban"></i></button></a></td>
                                    </tr>
