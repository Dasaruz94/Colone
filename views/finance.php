...
<body  style="background-image: url('../images/lock-screen2.jpg'); background-size: cover;">
<section id="container" >
            ...
            <div class="col-sm-12">
                <section class="panel" style="background: transparent;">
                    <header class="panel-heading">
                        <i class="fa fa-2x flaticon-money-1"></i> Caja
                        ...
                        <p style="font-weight: 200; text-transform: none; margin-top: 20px;">
                            Administra las finanzas de tu zona, ingresos, egresos y podres ver el
    ...
    if ($total == 0)
    {
        ...
        $sql= "INSERT INTO finance (id_place,total_money,created_at,created_by,updated_at,updated_by,active) VALUES
        ('".$_SESSION['id_place']."','0', '".date('Y-m-d h:i:s')."', '".$_SESSION['id']."', '".date('Y-m-d h:i:s')."', '".$_SESSION['id']."', '1')";
    ...
    ?>
                        ...
                        <div style=" background: rgba(255, 179, 0, 0.9); padding: 20px;">
                            <h1 style="font-size: 15px; color: white;"><i class="fa fa-2x flaticon-money-1" style="color: white; padding-right: 10px;"></i> CAJA</h1>
                        </div>
            ...
            <div class="col-lg-4" >
                <div style=" border: 5px solid rgba(0, 143, 206, 0.9);  margin: 5px; border-radius: 10px;">
                    <div style=" background: rgba(0, 143, 206, 0.9); padding: 20px;">
                        ...
                        <h1 style="font-size: 15px; color: white;"><i class="fa fa-2x flaticon-bars" style="color: white; padding-right: 10px;"></i> INGRESOS</h1>
                        ...
                        <div class="col-lg-4" >
                            <div style=" border: 5px solid rgba(255, 0, 52, 0.9);  margin: 5px; border-radius: 10px;">
                                <div style=" background: rgba(255, 0, 52, 0.9); padding: 20px;">
                                    ...
                                    <h1 style="font-size: 15px; color: white;"><i class="fa fa-2x flaticon-bars-1" style="color: white; padding-right: 10px;"></i> EGRESOS</h1>
