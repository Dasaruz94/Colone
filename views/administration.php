            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-2x fa-users"></i>  Administradores por zonas
                        ...
                        <p style="font-weight: 200; text-transform: none; margin-top: 20px;">   </p>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                    ...
                                    <div class="btn-group">
                                        <a href="../../sign-up.php" class="tooltipcolone"><button  id="editable-sample_new" class="btn btn-primary tooltipcolone">
                                                <span class="tooltipcolone-content">Agrega un administrador  <br> de manera manualun <br> inquilino </span>

                                                Añadir un administrador <i class="fa fa-plus"></i>
                                            </button></a>

                                        <p style="font-weight: 200; text-transform: none; margin-top: 20px;">  De forma manual, ingresando en esta liga www.colone.com.mx/sign-up.php agrega un nuevo administrador. </p>
                                        ...
                                        background: -webkit-linear-gradient(#00ff30, #b8ff00);"></span>
                            ...
                            <table class="table table-bordered table-striped table-condensed cf" id="editable-sample">
                                ...
                                while ($row1=mysqli_fetch_row($resultado1))
                                {
                                    ...
                                    <td class="center"><?php
                                        ...
                                        ?></td>
                                    <td><a class="edit""><button onclick="validateConfirm(<?php echo $idUsuario; ?>)" type="button" class="btn btn-primary"><i class="fa fa-pencil"></i> </button></a></td>
